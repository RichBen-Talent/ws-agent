...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.ws-agent", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("WsAgent/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__wsAgent__/a2ui/").absoluteString + "?platform=macos"
    }
