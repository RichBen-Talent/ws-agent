...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .wsAgentSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? WsAgentPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? WsAgentPaths.stateDirURL.path
...
extension Notification.Name {
    static let wsAgentSelectSettingsTab = Notification.Name("wsAgentSelectSettingsTab")
}
