...
enum WsAgentConfigFile {
    private static let logger = Logger(subsystem: "ai.ws-agent", category: "config")
    ...
    static func stateDirURL() -> URL {
        WsAgentPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        WsAgentPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-ws-agent-config-file",
            "event": "config.write",
