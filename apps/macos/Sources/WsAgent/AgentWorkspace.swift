...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.ws-agent", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return WsAgentConfigFile.defaultWorkspaceURL() }
