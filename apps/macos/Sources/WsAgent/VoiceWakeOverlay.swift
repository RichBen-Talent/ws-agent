...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.ws-agent", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other WsAgent windows, but below the system’s pop-up menus.
