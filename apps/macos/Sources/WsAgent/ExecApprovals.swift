...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.ws-agent", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        WsAgentPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        WsAgentPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
