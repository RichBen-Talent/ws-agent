...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (WsAgent token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: WsAgentOAuthStore.AnthropicOAuthStatus = WsAgentOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.ws-agent", category: "anthropic-oauth")
...
enum WsAgentOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let wsAgentOAuthDirEnv = "WS_AGENT_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "WsAgent OAuth token file not found"
            case .unreadableFile: "WsAgent OAuth token file not readable"
            case .invalidJSON: "WsAgent OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in WsAgent OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "WsAgent OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.wsAgentOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".ws-agent", isDirectory: true)
