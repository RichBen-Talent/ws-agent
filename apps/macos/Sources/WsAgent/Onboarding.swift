...
enum UIStrings {
    static let welcomeTitle = "Welcome to WsAgent"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "ws-agent.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: WsAgentOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: WsAgentChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g ws-agent@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: WsAgentChatViewModel(
