...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/ws-agent/ws-agent") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/ws-agent/ws-agent")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://ws-agent.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "WsAgentBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "WsAgentBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "WsAgentGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "WsAgentGitCommit") as? String) ??
            "unknown"
    }
