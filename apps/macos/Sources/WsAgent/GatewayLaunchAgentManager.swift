...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.ws-agent", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".ws-agent/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.wsAgentCommand(
            subcommand: "gateway",
