...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = WsAgentConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = WsAgentConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = WsAgentConfigFile.loadDict()
            ...
            WsAgentConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/ws-agent"
        state.remoteCliPath = ""
        return state
    }
}
