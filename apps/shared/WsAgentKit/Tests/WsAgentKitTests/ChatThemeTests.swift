...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = WsAgentChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = WsAgentChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
