...
public enum WsAgentTalkCommand: String, Codable, Sendable {
...
public struct WsAgentTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct WsAgentTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
