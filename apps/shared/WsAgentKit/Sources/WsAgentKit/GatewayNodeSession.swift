...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.ws-agent", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.ws-agent", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: WsAgentProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
