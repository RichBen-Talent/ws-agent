...
public enum WsAgentCanvasA2UICommand: String, Codable, Sendable {
...
public struct WsAgentCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct WsAgentCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
