...
@MainActor
public struct WsAgentChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: WsAgentChatViewModel
    ...
    public init(
        viewModel: WsAgentChatViewModel,
    ...
    private var visibleMessages: [WsAgentChatMessage] {
        let base: [WsAgentChatMessage]
    ...
    private func mergeToolResults(in messages: [WsAgentChatMessage]) -> [WsAgentChatMessage] {
    ...
    private func isToolResultMessage(_ message: WsAgentChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: WsAgentChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: WsAgentChatMessage) -> String {
