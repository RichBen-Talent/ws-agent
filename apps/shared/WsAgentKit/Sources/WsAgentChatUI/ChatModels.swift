...
public typealias WsAgentPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias WsAgentPlatformImage = UIImage
#endif

public struct WsAgentChatUsageCost: Codable, Hashable, Sendable {
...
public struct WsAgentChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: WsAgentChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(WsAgentChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct WsAgentChatMessageContent: Codable, Hashable, Sendable {
...
public struct WsAgentChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [WsAgentChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: WsAgentChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [WsAgentChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: WsAgentChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(WsAgentChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([WsAgentChatMessageContent].self, forKey: .content) {
...
public struct WsAgentChatHistoryPayload: Codable, Sendable {
...
public struct WsAgentSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct WsAgentSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [WsAgentSessionPreviewItem]
}

public struct WsAgentSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [WsAgentSessionPreviewEntry]

    public init(ts: Int, previews: [WsAgentSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct WsAgentChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct WsAgentChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct WsAgentAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct WsAgentChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct WsAgentGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct WsAgentPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: WsAgentPlatformImage?
...
public struct WsAgentChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
