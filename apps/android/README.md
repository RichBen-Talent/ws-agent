## WsAgent Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_ws-agent-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm ws-agent gateway --port 18789 --verbose
```
