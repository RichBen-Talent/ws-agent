...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: WsAgentPhotosLatestParams) async throws -> WsAgentPhotosLatestPayload {
        ...
        var results: [WsAgentPhotoPayload] = []
        ...
        return WsAgentPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> WsAgentPhotoPayload
    {
