...
function mergeDiscordAccountConfig(cfg: WsAgentConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: WsAgentConfig): ResolvedDiscordAccount[] {
