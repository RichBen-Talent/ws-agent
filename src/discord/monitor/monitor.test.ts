...
describe("agent components", () => {
  const createCfg = (): WsAgentConfig => ({}) as WsAgentConfig;
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/ws-agent-sessions-test.json");
  });
