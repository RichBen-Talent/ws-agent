...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/ws-agent/ws-agent/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.WS_AGENT_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.ws-agent/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: WsAgentConfig = {
    ...params.cfg,
