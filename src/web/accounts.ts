...
export function listWhatsAppAuthDirs(cfg: WsAgentConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: WsAgentConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: WsAgentConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: WsAgentConfig): ResolvedWhatsAppAccount[] {
