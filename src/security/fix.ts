...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof WsAgentConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: WsAgentConfig; env: NodeJS.ProcessEnv }): {
  cfg: WsAgentConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
