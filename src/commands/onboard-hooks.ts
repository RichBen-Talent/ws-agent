...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.ws-agent.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("ws-agent hooks list")}`,
      `  ${formatCliCommand("ws-agent hooks enable <name>")}`,
      `  ${formatCliCommand("ws-agent hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
