...
type PromptDefaultModelResult = { model?: string; config?: WsAgentConfig };
...
function resolveConfiguredModelRaw(cfg: WsAgentConfig): string {
...
function resolveConfiguredModelKeys(cfg: WsAgentConfig): string[] {
...
export function applyPrimaryModel(cfg: WsAgentConfig, model: string): WsAgentConfig {
...
export function applyModelAllowlist(cfg: WsAgentConfig, models: string[]): WsAgentConfig {
  const defaults = cfg.agents?.defaults;
