...
export function applyOpenrouterProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: WsAgentConfig): WsAgentConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: WsAgentConfig): WsAgentConfig {
...
export function applyMoonshotConfig(cfg: WsAgentConfig): WsAgentConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: WsAgentConfig): WsAgentConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: WsAgentConfig): WsAgentConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: WsAgentConfig): WsAgentConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: WsAgentConfig): WsAgentConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: WsAgentConfig): WsAgentConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: WsAgentConfig): WsAgentConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: WsAgentConfig): WsAgentConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: WsAgentConfig): WsAgentConfig {
...
export function applyQianfanProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: WsAgentConfig): WsAgentConfig {
