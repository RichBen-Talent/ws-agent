...
function resolveDefaultAccountId(cfg: WsAgentConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: WsAgentConfig): boolean {
...
export function summarizeBindings(cfg: WsAgentConfig, bindings: AgentBinding[]): string[] {
