...
export function applyVercelAiGatewayProviderConfig(cfg: WsAgentConfig): WsAgentConfig {
...
export function applyVercelAiGatewayConfig(cfg: WsAgentConfig): WsAgentConfig {
