...
function mergeSignalAccountConfig(cfg: WsAgentConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: WsAgentConfig): ResolvedSignalAccount[] {
