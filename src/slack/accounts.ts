...
function mergeSlackAccountConfig(cfg: WsAgentConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: WsAgentConfig): ResolvedSlackAccount[] {
