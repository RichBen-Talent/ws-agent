...
${formatHelpExamples([
  ['ws-agent message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'ws-agent message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'ws-agent message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.ws-agent.ai/cli/message")}`,
    )
    .action(() => {
