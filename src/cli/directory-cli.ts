    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["ws-agent directory self --channel slack", "Show the connected account identity."],
          [
            'ws-agent directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["ws-agent directory groups list --channel discord", "List available groups/channels."],
          [
            "ws-agent directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.ws-agent.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
