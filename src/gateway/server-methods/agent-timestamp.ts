 ...
 *
 * @see https://github.com/ws-agent/ws-agent/issues/3658
 */
...
/**
 * Build TimestampInjectionOptions from an WsAgentConfig.
 */
export function timestampOptsFromConfig(cfg: WsAgentConfig): TimestampInjectionOptions {
  return {
