...
import type { WsAgentConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: WsAgentConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: WsAgentConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: WsAgentConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: WsAgentConfig) => void;
  log: {
