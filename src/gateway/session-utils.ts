...
import { type WsAgentConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: WsAgentConfig): string[] {
...
export function listAgentsForGateway(cfg: WsAgentConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: WsAgentConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: WsAgentConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: WsAgentConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: WsAgentConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: WsAgentConfig): GatewaySessionsDefaults {
