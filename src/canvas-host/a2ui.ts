...
export const A2UI_PATH = "/__wsAgent__/a2ui";

export const CANVAS_HOST_PATH = "/__wsAgent__/canvas";

export const CANVAS_WS_PATH = "/__wsAgent__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.wsAgentCanvasA2UIAction.postMessage(...)
  // - Android: window.wsAgentCanvasA2UIAction.postMessage(...)
  const handlerNames = ["wsAgentCanvasA2UIAction"];
  ...
  globalThis.WsAgent = globalThis.WsAgent ?? {};
  globalThis.WsAgent.postMessage = postToNode;
  globalThis.WsAgent.sendUserAction = sendUserAction;
  globalThis.wsAgentPostMessage = postToNode;
  globalThis.wsAgentSendUserAction = sendUserAction;
