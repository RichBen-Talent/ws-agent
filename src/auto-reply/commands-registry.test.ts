...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@ws-agent", { botUsername: "ws-agent" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@ws-agent args", {
        botUsername: "ws-agent",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@ws-agent: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "ws-agent" })).toBe(
      "/help@otherbot",
    );
  });
