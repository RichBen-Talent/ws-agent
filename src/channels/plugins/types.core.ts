...
export type ChannelAgentToolFactory = (params: { cfg?: WsAgentConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: WsAgentConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: WsAgentConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: WsAgentConfig }) => boolean;
  supportsCards?: (params: { cfg: WsAgentConfig }) => boolean;
