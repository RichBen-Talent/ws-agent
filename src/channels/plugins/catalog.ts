...
import { discoverWsAgentPlugins } from "../../plugins/discovery.js";
import type { WsAgentPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, WsAgentPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["WS_AGENT_PLUGIN_CATALOG_PATHS", "WS_AGENT_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<WsAgentPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: WsAgentPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: WsAgentPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverWsAgentPlugins({ workspaceDir: options.workspaceDir });
