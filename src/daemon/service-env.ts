...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.WS_AGENT_STATE_DIR;
  const configPath = env.WS_AGENT_CONFIG_PATH;
  ...
  return {
    ...
    WS_AGENT_PROFILE: profile,
    WS_AGENT_STATE_DIR: stateDir,
    WS_AGENT_CONFIG_PATH: configPath,
    WS_AGENT_GATEWAY_PORT: String(port),
    WS_AGENT_GATEWAY_TOKEN: token,
    WS_AGENT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    WS_AGENT_SYSTEMD_UNIT: systemdUnit,
    WS_AGENT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    WS_AGENT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
