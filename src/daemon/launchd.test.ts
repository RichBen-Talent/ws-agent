...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.wsagent.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", WS_AGENT_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.wsagent.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.ws-agent.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when WS_AGENT_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.wsagent.gateway.plist",
    },
    {
      name: "uses profile-specific label when WS_AGENT_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", WS_AGENT_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.wsagent.jbphoenix.plist",
    },
    {
      name: "prefers WS_AGENT_LAUNCHD_LABEL over WS_AGENT_PROFILE",
      env: {
        HOME: "/Users/test",
        WS_AGENT_PROFILE: "jbphoenix",
        WS_AGENT_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from WS_AGENT_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        WS_AGENT_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty WS_AGENT_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        WS_AGENT_PROFILE: "myprofile",
        WS_AGENT_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.wsagent.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
