...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/ws-agent/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/ws-agent/extensions",
        global: "/Users/x/.ws-agent/extensions",
        workspace: "/Users/x/ws/.ws-agent/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.ws-agent/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/ws-agent/extensions",
        global: "/Users/x/.ws-agent/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.ws-agent/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/ws-agent/extensions",
        global: "/Users/x/.ws-agent/extensions",
