...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @ws-agent/voice-call -> voice-call).
...
export function discoverWsAgentPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".ws-agent", "extensions")];
