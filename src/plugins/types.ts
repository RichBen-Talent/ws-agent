...
export type WsAgentPluginConfigSchema = {
...
export type WsAgentPluginToolContext = {
...
export type WsAgentPluginToolFactory = (
  ctx: WsAgentPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type WsAgentPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type WsAgentPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<WsAgentConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type WsAgentPluginGatewayMethod = {
  method: string;
 ...
 */
export type WsAgentPluginCommandDefinition = {
...
export type WsAgentPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type WsAgentPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type WsAgentPluginCliContext = {
  program: Command;
  config: WsAgentConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type WsAgentPluginCliRegistrar = (ctx: WsAgentPluginCliContext) => void | Promise<void>;

export type WsAgentPluginServiceContext = {
  config: WsAgentConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type WsAgentPluginService = {
  id: string;
  start: (ctx: WsAgentPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: WsAgentPluginServiceContext) => void | Promise<void>;
};

export type WsAgentPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type WsAgentPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: WsAgentPluginConfigSchema;
  register?: (api: WsAgentPluginApi) => void | Promise<void>;
  activate?: (api: WsAgentPluginApi) => void | Promise<void>;
};

export type WsAgentPluginModule =
  | WsAgentPluginDefinition
  | ((api: WsAgentPluginApi) => void | Promise<void>);

export type WsAgentPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | WsAgentPluginToolFactory,
    opts?: WsAgentPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: WsAgentPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: WsAgentPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: WsAgentPluginHttpRouteHandler }) => void;
  registerChannel: (registration: WsAgentPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: WsAgentPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: WsAgentPluginService) => void;
   ...
   */
  registerCommand: (command: WsAgentPluginCommandDefinition) => void;
