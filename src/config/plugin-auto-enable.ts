...
function isTelegramConfigured(cfg: WsAgentConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: WsAgentConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: WsAgentConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: WsAgentConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: WsAgentConfig): boolean {
...
function isIMessageConfigured(cfg: WsAgentConfig): boolean {
...
function isWhatsAppConfigured(cfg: WsAgentConfig): boolean {
...
function isGenericChannelConfigured(cfg: WsAgentConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: WsAgentConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: WsAgentConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: WsAgentConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: WsAgentConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: WsAgentConfig, pluginId: string): WsAgentConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
