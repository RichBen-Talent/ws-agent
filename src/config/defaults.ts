...
function resolveAnthropicDefaultAuthMode(cfg: WsAgentConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: WsAgentConfig): WsAgentConfig {
...
export function applyTalkApiKey(config: WsAgentConfig): WsAgentConfig {
...
export function applyModelDefaults(cfg: WsAgentConfig): WsAgentConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: WsAgentConfig): WsAgentConfig {
...
export function applyLoggingDefaults(cfg: WsAgentConfig): WsAgentConfig {
...
export function applyContextPruningDefaults(cfg: WsAgentConfig): WsAgentConfig {
...
export function applyCompactionDefaults(cfg: WsAgentConfig): WsAgentConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
