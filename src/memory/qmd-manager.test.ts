...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: WsAgentConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: WsAgentConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__wsAgentMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__wsAgentMcporterColdStartWarned;
  });
