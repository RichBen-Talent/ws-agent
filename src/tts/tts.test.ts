...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.WS_AGENT_TTS_PREFS;
      process.env.WS_AGENT_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.WS_AGENT_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: WsAgentConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
