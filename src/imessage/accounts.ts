...
function mergeIMessageAccountConfig(cfg: WsAgentConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: WsAgentConfig): ResolvedIMessageAccount[] {
