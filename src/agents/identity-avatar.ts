...
function resolveAvatarSource(cfg: WsAgentConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: WsAgentConfig, agentId: string): AgentAvatarResolution {
