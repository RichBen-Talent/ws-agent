...
const CLEANUP_STATE_KEY = Symbol.for("ws-agent.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("ws-agent.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("ws-agent.sessionWriteLockWatchdogState");
