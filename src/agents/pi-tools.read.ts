...
function resolveAdaptiveReadMaxBytes(options?: WsAgentReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createWsAgentReadTool(base, {
...
export function createWsAgentReadTool(
  base: AnyAgentTool,
  options?: WsAgentReadToolOptions,
): AnyAgentTool {
