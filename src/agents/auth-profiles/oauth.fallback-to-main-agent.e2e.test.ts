...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveWsAgentAgentDir() returns mainAgentDir
    process.env.WS_AGENT_STATE_DIR = tmpDir;
    process.env.WS_AGENT_AGENT_DIR = mainAgentDir;
