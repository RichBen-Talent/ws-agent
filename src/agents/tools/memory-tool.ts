...
function resolveMemoryToolContext(options: { config?: WsAgentConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: WsAgentConfig): MemoryCitationsMode {
