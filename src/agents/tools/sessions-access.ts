...
export function resolveSessionToolsVisibility(cfg: WsAgentConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: WsAgentConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: WsAgentConfig): AgentToAgentPolicy {
