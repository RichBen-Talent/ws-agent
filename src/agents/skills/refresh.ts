...
function resolveWatchPaths(workspaceDir: string, config?: WsAgentConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: WsAgentConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: WsAgentConfig }) {
