...
describe("buildSandboxCreateArgs", () => {
  ...
  it("includes hardening and resource flags", () => {
    ...
    const args = buildSandboxCreateArgs({
      name: "ws-agent-sbx-test",
      cfg,
      scopeKey: "main",
      createdAtMs: 1700000000000,
      labels: { "ws-agent.sandboxBrowser": "1" },
    });
    ...
    expect(args).toEqual(
      expect.arrayContaining([
        ...
        "ws-agent.sandbox=1",
        "--label",
        "ws-agent.sessionKey=main",
        "--label",
        "ws-agent.createdAtMs=1700000000000",
        "--label",
