...
export const DEFAULT_SANDBOX_IMAGE = "ws-agent-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "ws-agent-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "ws-agent-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "ws-agent-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "ws-agent-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "ws-agent-sandbox-browser";
