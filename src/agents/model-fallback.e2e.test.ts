...
function makeCfg(overrides: Partial<WsAgentConfig> = {}): WsAgentConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): WsAgentConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): WsAgentConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {
