...
export function listBindings(cfg: WsAgentConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: WsAgentConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: WsAgentConfig) {
