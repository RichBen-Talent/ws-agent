...
if [[ -z "$version_content" ]]; then
  echo "<h2>WsAgent $VERSION</h2>"
  echo "<p>Latest WsAgent update.</p>"
  echo "<p><a href=\"https://github.com/ws-agent/ws-agent/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
