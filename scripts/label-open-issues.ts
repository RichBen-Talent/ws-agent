...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "ws-agent", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for WsAgent. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("WsAgent Issue Label Audit");
