...
# Output:
# - dist/WsAgent.app
# - dist/WsAgent-<version>.zip
# - dist/WsAgent-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.wsagent.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/WsAgent.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/WsAgent-$VERSION.zip"
DMG="$ROOT_DIR/dist/WsAgent-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/WsAgent-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/WsAgent-$VERSION.dSYM.zip"
