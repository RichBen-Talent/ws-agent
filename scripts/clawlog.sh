...
show_usage() {
    cat << EOF
clawlog - WsAgent Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View WsAgent logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    WsAgent logs flow through the macOS unified log (subsystem: ai.ws-agent).
