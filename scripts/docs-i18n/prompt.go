...
- Keep product names in English: WsAgent, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the WsAgent Gateway, use “Gateway 网关”.
