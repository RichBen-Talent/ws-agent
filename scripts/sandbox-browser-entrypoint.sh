...
export DISPLAY=:1
export HOME=/tmp/ws-agent-home
export XDG_CONFIG_HOME="${HOME}/.config"
export XDG_CACHE_HOME="${HOME}/.cache"

CDP_PORT="${WS_AGENT_BROWSER_CDP_PORT:-${WS_AGENT_BROWSER_CDP_PORT:-9222}}"
CDP_SOURCE_RANGE="${WS_AGENT_BROWSER_CDP_SOURCE_RANGE:-${WS_AGENT_BROWSER_CDP_SOURCE_RANGE:-}}"
VNC_PORT="${WS_AGENT_BROWSER_VNC_PORT:-${WS_AGENT_BROWSER_VNC_PORT:-5900}}"
NOVNC_PORT="${WS_AGENT_BROWSER_NOVNC_PORT:-${WS_AGENT_BROWSER_NOVNC_PORT:-6080}}"
ENABLE_NOVNC="${WS_AGENT_BROWSER_ENABLE_NOVNC:-${WS_AGENT_BROWSER_ENABLE_NOVNC:-1}}"
HEADLESS="${WS_AGENT_BROWSER_HEADLESS:-${WS_AGENT_BROWSER_HEADLESS:-0}}"
ALLOW_NO_SANDBOX="${WS_AGENT_BROWSER_NO_SANDBOX:-${WS_AGENT_BROWSER_NO_SANDBOX:-0}}"
NOVNC_PASSWORD="${WS_AGENT_BROWSER_NOVNC_PASSWORD:-${WS_AGENT_BROWSER_NOVNC_PASSWORD:-}}"
