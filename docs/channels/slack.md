...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure WsAgent HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `ws-agent pairing approve slack <code>`.
...
WsAgent supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, WsAgent falls back to normal delivery for remaining payloads.
