...
WsAgent treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.ws-agent/settings/voicewake.json`

Shape:

```json
{ "triggers": ["ws-agent", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
