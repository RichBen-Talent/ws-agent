...
本指南总结了在 WsAgent 中开发 Pi 集成的合理工作流程。
...
状态存储在 WsAgent 状态目录下。默认为 `~/.ws-agent`。如果设置了 `WS_AGENT_STATE_DIR`，则使用该目录。
...
- https://docs.ws-agent.ai/testing
- https://docs.ws-agent.ai/start/getting-started
