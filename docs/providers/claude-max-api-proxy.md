...
You can point WsAgent at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or WsAgent
...
- [Anthropic provider](/providers/anthropic) - Native WsAgent integration with Claude setup-token or API keys
