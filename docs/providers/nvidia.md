---
summary: "Use NVIDIA's OpenAI-compatible API in WsAgent"
read_when:
  - You want to use NVIDIA models in WsAgent
...
ws-agent onboard --auth-choice skip
ws-agent models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
