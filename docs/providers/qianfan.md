---
summary: "Use Qianfan's unified API to access many models in WsAgent"
read_when:
...
3. WsAgent installed on your system
...
4. Copy the API key for use with WsAgent

## CLI setup

```bash
ws-agent onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [WsAgent Configuration](/gateway/configuration)
