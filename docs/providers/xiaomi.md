---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with WsAgent"
read_when:
  - You want Xiaomi MiMo models in WsAgent
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). WsAgent uses
