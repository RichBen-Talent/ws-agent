---
summary: "Use Qwen OAuth (free tier) in WsAgent"
read_when:
  - You want to use Qwen with WsAgent
...
If you already logged in with the Qwen Code CLI, WsAgent will sync credentials
