---
summary: "First-run onboarding flow for WsAgent (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give WsAgent">
...
<Step title="CLI">
  ...
  The app can install the global `ws-agent` CLI via npm/pnpm so terminal
