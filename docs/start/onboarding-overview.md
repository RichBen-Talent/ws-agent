---
summary: "Overview of WsAgent onboarding options and flows"
read_when:
...
WsAgent supports multiple onboarding paths depending on where the Gateway runs
...
- [`ws-agent onboard` command](/cli/onboard)

## macOS app onboarding

Use the WsAgent app when you want a fully guided setup on macOS. Docs:
