...
- Same path: run the app from a fixed location (for WsAgent, `dist/WsAgent.app`).
...
Workaround: move files into the WsAgent workspace (`~/.ws-agent/workspace`) if you want to avoid per-folder grants.
