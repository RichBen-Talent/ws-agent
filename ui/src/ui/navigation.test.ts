...
describe("subtitleForTab", () => {
  ...
  it("returns descriptive subtitles", () => {
    ...
    expect(subtitleForTab("config")).toContain("ws-agent.json");
  });
});
...
describe("normalizeBasePath", () => {
  it("normalizes base-path variants", () => {
    const cases = [
      ...
      { input: "/ui/", expected: "/ui" },
      { input: "/", expected: "" },
      { input: "/apps/ws-agent", expected: "/apps/ws-agent" },
    ] as const;
    for (const testCase of cases) {
...
describe("pathForTab", () => {
  it("builds tab paths with optional bases", () => {
    const cases = [
      ...
      { tab: "sessions", base: "/apps/ws-agent", expected: "/apps/ws-agent/sessions" },
    ] as const;
    for (const testCase of cases) {
      expect(
...
describe("tabFromPath", () => {
  it("resolves tabs from path variants", () => {
    const cases = [
      ...
      { path: "/apps/ws-agent/sessions", base: "/apps/ws-agent", expected: "sessions" },
...
describe("inferBasePathFromPathname", () => {
  it("infers base-path variants from pathname", () => {
    const cases = [
      ...
      { path: "/apps/ws-agent/sessions", expected: "/apps/ws-agent" },
