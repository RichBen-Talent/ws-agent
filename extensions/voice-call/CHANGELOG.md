...
- Version alignment with core WsAgent release numbers.
...
- First public release of the @ws-agent/voice-call plugin.
...
- CLI: `ws-agent voicecall` commands (call/start/continue/speak/end/status/tail/expose).
