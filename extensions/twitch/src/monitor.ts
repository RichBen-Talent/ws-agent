...
import type { ReplyPayload, WsAgentConfig } from "ws-agent/plugin-sdk";
import { createReplyPrefixOptions } from "ws-agent/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as WsAgentConfig;
