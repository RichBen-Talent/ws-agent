...
export function listMattermostAccountIds(cfg: WsAgentConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: WsAgentConfig): string {
...
export function listEnabledMattermostAccounts(cfg: WsAgentConfig): ResolvedMattermostAccount[] {
