import type { ChannelOnboardingAdapter, WsAgentConfig, WizardPrompter } from "ws-agent/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.ws-agent.ai/channels/mattermost",
    ].join("\n"),
