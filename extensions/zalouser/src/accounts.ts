...
export function listZalouserAccountIds(cfg: WsAgentConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: WsAgentConfig): string {
...
function mergeZalouserAccountConfig(cfg: WsAgentConfig, accountId: string): ZalouserAccountConfig {
