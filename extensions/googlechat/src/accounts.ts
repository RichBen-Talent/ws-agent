...
export function listGoogleChatAccountIds(cfg: WsAgentConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: WsAgentConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: WsAgentConfig): ResolvedGoogleChatAccount[] {
