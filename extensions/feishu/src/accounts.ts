...
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "ws-agent/plugin-sdk/account-id";
import type {
  FeishuConfig,
  FeishuAccountConfig,
  FeishuDomain,
 ...
 */
export function listFeishuAccountIds(cfg: WsAgentConfig): string[] {
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: WsAgentConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: WsAgentConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: WsAgentConfig): ResolvedFeishuAccount[] {
