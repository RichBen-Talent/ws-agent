...
import type { WsAgentConfig, PluginRuntime, RuntimeEnv } from "ws-agent/plugin-sdk";
...
async function dispatchMessage(params: { cfg: WsAgentConfig; event: FeishuMessageEvent }) {
