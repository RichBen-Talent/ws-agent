...
export function listBlueBubblesAccountIds(cfg: WsAgentConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: WsAgentConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: WsAgentConfig): ResolvedBlueBubblesAccount[] {
