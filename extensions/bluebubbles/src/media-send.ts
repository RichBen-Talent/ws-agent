...
import { resolveChannelMediaMaxBytes, type WsAgentConfig } from "ws-agent/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: WsAgentConfig; accountId?: string }): string[] {
