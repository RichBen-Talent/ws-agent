...
This directory contains the **BlueBubbles external channel plugin** for WsAgent.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `ws-agent/plugin-sdk` helpers.
